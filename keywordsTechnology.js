...
var fs = require('fs');
var array = fs.readFileSync('sitesTechnology.txt').toString().split("\n");
for(i in array) 
{
    var url = array[i];
    request(url, (error, response, html) => 
    {
        ...
        {
            var wstream = fs.createWriteStream('DataTechnology.txt');
...
const OUTPUT_FILE = 'wordsTechnology.json'
var testString = fs.readFileSync('DataTechnology.txt').toString();
...
let countArray=[];
        ...
        const autoTrain = require('./wordsTechnology.json');
        trainedPath = 'wordsTechnology.json'
        let addWords=[];
